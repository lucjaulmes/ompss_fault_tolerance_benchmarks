...
*/
static void stockham(complex_struct x[], int n, int flag, int n2, complex_struct y[])
{
   complex_struct  *y_orig, *tmp;
...
*/
static void cooley_tukey(complex_struct x[], int n, int flag, int n2)
{
   complex_struct c;
   int i, j, k, m, p, n1;
   int Ls, ks, ms, jm, dk;
...
void ref_fft(complex_struct x[], int n, int flag)
{
   ...
   y = (complex_struct *) malloc( n*sizeof(complex_struct) );
   assert(NULL != y);
...
void ref_fft2D(complex_struct x[], int n1, int n2, int flag)
{
   ...
   assert(1 == flag || -1 == flag);
   n = n1*n2;
   y = (complex_struct *) malloc( n2*sizeof(complex_struct) );
   assert(NULL != y);
...
void ref_fft3D(complex_struct x[], int n1, int n2, int n3, int flag)
{
   ...
   n23 = n2*n3;
   n = n1*n23;
   y = (complex_struct *) malloc( n23*sizeof(complex_struct) );
   assert(NULL != y);
